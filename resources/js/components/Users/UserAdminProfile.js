...
import {getLoginUser,updateLoginUser,changeMyPasswordAdmin} from '../Actions/admin';
    class UserAdminProfile extends Component {
      constructor (props) {
        super(props)
        this.state = {
          user:{
...
//const userId= this.props.match.params.id;
      ...
      render () {
        const { project, tasks } = this.state
          return (
          <div>
           <h1 className="h3 mb-4 text-gray-800">Admin Profile</h1>
                ...
                <div className="card-body">
                  <Formik
                   ...
                   // this.handleChangePassword(values);
                      changeMyPasswordAdmin(values, res=>{
                       // console
                       if(res.errors)
                       {
