...
componentDidMount()
{
  ...
  getLoginUser(response=>{
    ...
    {  
      ...
      render(){
        return this.state.isLoggedOut? <Redirect to="/auth/login"/>:(
    <div id="wrapper">
    ...
    <ul className="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a className="sidebar-brand d-flex align-items-center justify-content-center" href="#">
        ...
        <div className="sidebar-brand-text mx-3">JSCOE   <small> HOSTEL Reservation</small></div>
      </a>
 ...
 <li className="nav-item">
         <Link to='/student/reservation' className="nav-link">
          ...
          <ul className="navbar-nav ml-auto">
            ...
            <li className="nav-item dropdown no-arrow">
              ...
              <div className="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                  ...
                  <Link to='/student/profile' className="dropdown-item" ><i className="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i><span className="collapse-item">My Account</span></Link>
                  {/*
